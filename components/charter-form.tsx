...
export function CharterForm() {
  ...
  if (submitted !== null) {
    return (
      <div className="mx-auto max-w-lg rounded-3xl border border-[var(--home-border)] bg-[var(--home-surface)] p-8 text-center shadow-[0_2px_24px_-8px_rgba(11,31,42,0.08)]">
  ...
  return (
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
      ...
      <div className="lg:col-span-2">
        <div className="sticky top-24 rounded-3xl border border-[var(--home-border)] bg-[var(--home-surface)] p-6 shadow-[0_2px_24px_-8px_rgba(11,31,42,0.08)]">
